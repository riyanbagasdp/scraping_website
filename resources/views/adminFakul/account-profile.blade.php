...
<body>
    ...
    <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item">
                            <a href="dashboardAdminFakultas.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="statistikdminFakultas.html" class='sidebar-link'>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item">
                                    <a href="dosenAdminFakultas.html" class="submenu-link">Dosen</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="adminProdiFakultas.html" class="submenu-link">Admin Prodi</a>
                                </li>
                            </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <h3 class="mt-3">Supardi</h3>
                            <p class="text-small">Admin Fakultas</p>
                        </div>
                    </div>
                </div>
            </div>
