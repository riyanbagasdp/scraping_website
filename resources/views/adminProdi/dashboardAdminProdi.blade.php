...
<body>
                    ...
                    <div class="col-12 col-lg-9">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Statistik Sitasi Artikel Jurnal Prodi</h4>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        ...
                                        <h6 class="text-muted mb-0">Admin Prodi</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="../assets/static/js/pages/ui-chartjsProdi.js"></script>
</body>
