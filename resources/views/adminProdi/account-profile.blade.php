...
<body>
    ...
    <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item">
                            <a href="dashboardAdminProdi.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="statistikadminprodi.html" class='sidebar-link'>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item">
                                    <a href="dosenAdminProdi.html" class="submenu-link">Dosen</a>
                                </li>
                            </ul>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <h3 class="mt-3">Basori</h3>
                            <p class="text-small">Dosen Teladan</p>
                        </div>
                    </div>
                </div>
            </div>
