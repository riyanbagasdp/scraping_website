            ...
            <div class="page-content">
                <section class="section">
                    ...
                    <div class="page-heading">
                        <h3>Data Publikasi dan Sitasi Dosen Program Studi ..</h3>
                    </div>
                    <div class="card">
                        <div class="card-body">
                ...
                <section class="section">
                    <div class="page-heading">
                        <h3>Perbandingan Jumlah Sitasi Dosen Prodi dengan Dosen se-Fakultas</h3>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div id="bar"></div>
                ...
                <section class="section">
                    <div class="page-heading">
                        <h3>Histori Publikasi Dosen Program Studi ..</h3>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
