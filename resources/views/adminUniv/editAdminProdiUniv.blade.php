                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">Nama Admin</label>
                                                        <input type="text" id="nama-admin" class="form-control"
                                                            placeholder="Nama Admin" name="nama-admin">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
