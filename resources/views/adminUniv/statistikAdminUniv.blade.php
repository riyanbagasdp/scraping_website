            ...
            <div class="page-content">
                <section class="section">
                    ...
                    <div class="page-heading">
                        <h3>Data Publikasi dan Sitasi Dosen Universitas Sebelas Maret</h3>
                    </div>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <table class="table tablex">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>FKIP</td>
                                            <td>Pengaruh Hasil Belajar Tanpa Metode Pembelajaran</td>
                                            <td>
                                                2018
                                            </td>
                                            <td>700</td>
                ...
                <section class="section">
                    <div class="page-heading">
                        <h3>Histori Publikasi Dosen Universitas Sebelas Maret</h3>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
