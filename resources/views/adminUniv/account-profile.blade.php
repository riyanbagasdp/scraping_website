...
<head>
    ...
    <title>Account Profile - Manajemen Sitasi</title>
...
<body>
    ...
    <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item">
                            <a href="dashboardAdminUniv.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="statistikdminUniv.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="fakultas.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item">
                            <a href="prodi.html" class='sidebar-link'>
                        ...
                        <li
                            class="sidebar-item  ">
                            <a href="dosen.html" class='sidebar-link'>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item">
                                    <a href="dosenAdminUniv.html" class="submenu-link">Dosen</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="adminProdiUniv.html" class="submenu-link">Admin Prodi</a>
                                </li>
                                <li class="submenu-item">
                                    <a href="adminFakulUniv.html" class="submenu-link">Admin Fakultas</a>
                                </li>
                            </ul>
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="../index.html" class="submenu-link">Log Out</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            ...
                            <h3 class="mt-3">Sularto</h3>
                            <p class="text-small">Admin Universitas</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form action="#" method="get">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control" placeholder="Nama" value="Basori">
                            </div>
                            <div class="form-group">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" name="email" id="email" class="form-control" placeholder="Email" value="john.doe@example.net">
                            </div>
                            <div class="form-group">
