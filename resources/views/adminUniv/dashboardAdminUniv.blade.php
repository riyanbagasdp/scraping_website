...
<head>
    ...
    <title>Dashboard Admin Universitas - Manajemen Sitasi</title>
            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            class="sidebar-item">
                            <a href="statistikAdminUniv.html" class='sidebar-link'>
                    ...
                    <div class="col-12 col-lg-9">
                                    ...
                                    <div class="card-body px-4 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                ...
                                                <h6 class="font-extrabold mb-0">12.700</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Statistik Sitasi Artikel Jurnal Universitas Sebelas Maret</h4>
                            </div>
                            <div class="card-body">
                                <canvas id="universitas"></canvas>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body py-4 px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Sartono</h5>
                                        <h6 class="text-muted mb-0">Admin Universitas</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
